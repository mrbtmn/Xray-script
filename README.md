...
### 2. 获取/更新脚本
```bash
wget -O Xray-TLS+Web-setup.sh https://github.com/mrbtmn/Xray-script/raw/main/Xray-TLS+Web-setup.sh
```
### 3. 执行脚本
```bash
...
## 运行截图
<div>
    <img src="https://github.com/mrbtmn/Xray-script/blob/main/image/Xray_menu.jpg">
</div>
<div>
